...
from match.IDBasedEntityMatchers import AppleEntityMatcher
...
def add_artist(entity, appleAPI, sink, pool, all_artists, all_albums, all_songs):
    ...
    results = appleAPI.lookup(id=entity.aid, media='music', entity='album', limit=32, transform=True)
    ...
    results = appleAPI.lookup(id=entity.aid, media='music', entity='song', limit=32, transform=True)
