...
__all__ = [ "PhillyMagCrawler" ]

class PhillyMagCrawler(AExternalEntitySource):
    
    TYPES = set([ 'restaurant' ])
    
    def __init__(self):
        AExternalEntitySource.__init__(self, "PhillyMag", self.TYPES, 512)
        self._seen = set()
    ...
    def _run(self):
        ...
        pool = Pool(512)
        seed = 'http://www.phillymag.com/restaurants/find_restaurant/index.html?show_ad'
