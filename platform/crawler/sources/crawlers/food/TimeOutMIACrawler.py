...
class TimeOutMIACrawler(AExternalEntitySource):
    
    TYPES = set([ 'restaurant' ])
    
    def __init__(self):
        AExternalEntitySource.__init__(self, "TimeOutMIA", self.TYPES, 512)
        self._seen = set()
    ...
    def _run(self):
        ...
        href = [
            'http://www.timeout.com/miami/search/tag/4256/restaurants-cafes',
            'http://www.timeout.com/miami/search/tag/4298/bars-pubs'
        ]
