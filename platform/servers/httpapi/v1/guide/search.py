...
from api_old.Schemas import GuideSearchRequest
...
class HTTPForm(Schema):
    ...
    def export_guide_search_request(self):
...
@stamped_http_api_request(requires_auth=False, form=HTTPForm, conversion=HTTPForm.export_guide_search_request, 
