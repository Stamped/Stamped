...
from servers.httpapi.v1.schemas import HTTPTimeSlice, HTTPStamp
...
@stamped_http_api_request(requires_auth=False, form=HTTPTimeSlice, conversion=HTTPTimeSlice.exportTimeSlice, 
    exceptions=exceptions)
def run(request, auth_user_id, schema, **kwargs):

    ### RESTRUCTURE TODO: Add caching

    stamps = stamp_api.getStampCollection(schema, auth_user_id)
