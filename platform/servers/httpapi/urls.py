...
urlpatterns = patterns('',
    ...
    ### ACCOUNT
    (r'v1/account/create.json',                             'v1.accounts.create.run'),
    (r'v1/account/create/facebook.json',                    'v1.accounts.create_facebook.run'),
    (r'v1/account/create/twitter.json',                     'v1.accounts.create_twitter.run'),
    (r'v1/account/upgrade.json',                            'v1.accounts.upgrade.run'),
    (r'v1/account/remove.json',                             'v1.accounts.remove.run'),
    (r'v1/account/update.json',                             'v1.accounts.update.run'),
    (r'v1/account/show.json',                               'v1.accounts.show.run'),
    (r'v1/account/customize_stamp.json',                    'v1.accounts.customize_stamp.run'),
    (r'v1/account/check.json',                              'v1.accounts.check.run'),
    (r'v1/account/change_password.json',                    'v1.accounts.change_password.run'),
    (r'v1/account/alerts/show.json',                        'v1.accounts.show_alerts.run'),
    (r'v1/account/alerts/update.json',                      'v1.accounts.update_alerts.run'),
    (r'v1/account/alerts/ios/update.json',                  'v1.accounts.update_apns.run'),
    (r'v1/account/alerts/ios/remove.json',                  'v1.accounts.remove_apns.run'),
