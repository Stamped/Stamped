...
urlpatterns = patterns('',
    ...
    (r'v0/account/linked/twitter/add.json',                 'v0.functions.linked.add', {'service_name' : 'twitter'}),
    (r'v0/account/linked/twitter/update.json',              'v0.functions.linked.add', {'service_name' : 'twitter'}),
    (r'v0/account/linked/twitter/remove.json',              'v0.functions.linked.remove', {'service_name' : 'twitter'}),
    (r'v0/account/linked/facebook/add.json',                'v0.functions.linked.add', {'service_name' : 'facebook'}),
    (r'v0/account/linked/facebook/update.json',             'v0.functions.linked.add', {'service_name' : 'facebook'}),
    (r'v0/account/linked/facebook/remove.json',             'v0.functions.linked.remove', {'service_name' : 'facebook'}),
    ...
    (r'v0/account/linked/netflix/add.json',                 'v0.functions.linked.add', {'service_name' : 'netflix'}),
    (r'v0/account/linked/netflix/update.json',              'v0.functions.linked.add', {'service_name' : 'netflix'}),
    (r'v0/account/linked/netflix/remove.json',              'v0.functions.linked.remove', {'service_name' : 'netflix'}),
    ...
    (r'v0/account/linked/rdio/add.json',                    'v0.functions.linked.add', {'service_name' : 'rdio'}),
    (r'v0/account/linked/rdio/update.json',                 'v0.functions.linked.add', {'service_name' : 'rdio'}),
    (r'v0/account/linked/rdio/remove.json',                 'v0.functions.linked.remove', {'service_name' : 'rdio'}),
    ...
    (r'v0/users/invite/twitter/collection.json',            'v0.functions.users.inviteTwitterCollection'),
    (r'v0/users/invite/email.json',                         'v0.functions.friendships.invite'),
