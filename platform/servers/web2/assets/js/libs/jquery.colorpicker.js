...
(function ($) {
	...
	var _colorpicker_index = 0,
        ...
        _parseColor = function(color) {
            ...
            var imp = " !important";
            if (endsWith(color, imp)) {
                color = color.substr(0, color.length - imp.length);
            }
        ...
        Color = function () {
			...
			this.toHex = function() {
				var rgb = this.getRGB();
				var h = _hexify(rgb.r * 255) + _hexify(rgb.g * 255) + _hexify(rgb.b * 255);
	...
	$.widget("vanderlee.colorpicker", {
		options: {
			...
			buttonImage:		'/assets/img/colorpicker/ui-colorpicker.png',
