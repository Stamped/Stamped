...
@synthesize searchIdentifier = _searchIdentifier;
...
- (id)initWithCoder:(NSCoder *)decoder {
    ...
    if (self) {
        ...
        _searchIdentifier = [[decoder decodeObjectForKey:@"searchIdentifier"] retain];
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    ...
    [encoder encodeObject:self.searchIdentifier forKey:@"searchIdentifier"];
