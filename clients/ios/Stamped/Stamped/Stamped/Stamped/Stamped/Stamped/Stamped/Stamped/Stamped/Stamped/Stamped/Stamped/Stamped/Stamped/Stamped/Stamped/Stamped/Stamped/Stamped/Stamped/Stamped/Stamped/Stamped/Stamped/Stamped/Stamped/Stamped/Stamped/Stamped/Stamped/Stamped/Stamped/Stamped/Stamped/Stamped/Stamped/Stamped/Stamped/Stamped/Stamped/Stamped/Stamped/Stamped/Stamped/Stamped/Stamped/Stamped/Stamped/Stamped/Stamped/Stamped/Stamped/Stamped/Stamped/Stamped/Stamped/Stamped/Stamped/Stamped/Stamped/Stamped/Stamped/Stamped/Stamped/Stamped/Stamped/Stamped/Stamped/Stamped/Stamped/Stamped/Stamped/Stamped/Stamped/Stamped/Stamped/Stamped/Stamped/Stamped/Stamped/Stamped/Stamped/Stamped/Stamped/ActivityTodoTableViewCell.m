...
@implementation ActivityTodoTableViewCell

- (id)initWithReuseIdentifier:(NSString*)reuseIdentifier {
  self = [super initWithReuseIdentifier:reuseIdentifier];
  if (self) {    
    badgeImageView_.image = [UIImage imageNamed:@"activity_todo_badge"];
  }
  return self;
}
...
- (NSAttributedString*)headerAttributedStringWithColor:(UIColor*)color {
  ...
  NSString* full = [NSString stringWithFormat:@"%@ to-do'd %@", user, entityTitle];
