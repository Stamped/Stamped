...
- (void)viewDidLoad {
    ...
    UIImage *image = [UIImage imageNamed:@"DEVIN_shelf_background"];
    ...
    CGRect shelfFrame = shelfBackground.frame;
    shelfFrame.size.width = 320;
    shelfBackground.frame = shelfFrame;
    ...
    [Util reframeView:backgroundImage withDeltas:CGRectMake(0, -64, 0, 0)];
