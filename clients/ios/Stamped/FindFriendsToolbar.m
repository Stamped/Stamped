...
- (void)commonInit {
  ...
  [addEmailsButton_ setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 5)];
  [addEmailsButton_ setImage:[UIImage imageNamed:@"buttonImg_addEmail_grey"] forState:UIControlStateNormal];
  [addEmailsButton_ setImage:[UIImage imageNamed:@"buttonImg_addEmail"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews {
  ...
  width = CGRectGetWidth(previewButton_.frame) + 25;
  previewButton_.frame = CGRectMake(10, 10, width, 29);

  [addEmailsButton_ sizeToFit];
  width = CGRectGetWidth(addEmailsButton_.frame) + 40;
  addEmailsButton_.frame = CGRectMake(CGRectGetMaxX(previewButton_.frame) + 10, 10, width, 29);
...
- (void)setInviteMode:(BOOL)inviteMode showEmailButton:(BOOL)showEmailButton {
  ...
  [UIView animateWithDuration:0.2
                   ...
                   animations:^{
                     ...
                     addEmailsButton_.alpha = (inviteMode && showEmailButton) ? 1.0 : 0.0;
...
- (void)buttonPressed:(id)sender {
  ...
  } else if (sender == addEmailsButton_) {
    [delegate_ toolbar:self emailButtonPressed:addEmailsButton_];
  }
}
