...
- (id)initWithCoder:(NSCoder *)decoder {
    NSString* entityID = [decoder decodeObjectForKey:@"entityID"];
    id<STEntity> entity = [[STStampedAPI sharedInstance] cachedEntityForEntityID:entityID];
    if (entity) {
        [self autorelease];
        return (id)[entity retain];
    }
    else {
